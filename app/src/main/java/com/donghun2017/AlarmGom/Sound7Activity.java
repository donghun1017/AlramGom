...
public class Sound7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adView = (AdView)findViewById(R.id.adview7);
        AdRequest adRequest = new AdRequest.Builder().build();
        adView.loadAd(adRequest);

        mp3 = MediaPlayer.create(this, R.raw.rain_sound7);
        mp3.setLooping(true);
        mp33 = MediaPlayer.create(this, R.raw.piano_sound7);

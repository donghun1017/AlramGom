...
public class Sound6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adView = (AdView)findViewById(R.id.adview6);
        AdRequest adRequest = new AdRequest.Builder().build();
        adView.loadAd(adRequest);

        mp3 = MediaPlayer.create(this, R.raw.rain_sound6);
        mp3.setLooping(true);
        mp33 = MediaPlayer.create(this, R.raw.piano_sound6);
